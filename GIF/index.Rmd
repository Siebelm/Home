...
Creating a GIF in <code>ggplot</code> is extremely simple and only requires one additional package beyond <code>ggplot2</code>.
...
<a href="https://www.youtube.com/watch?v=jbkSRLYSojo" target="_blank">Youtube Link</a>
...
To accomplish this, I need to create a function that will loop through several plots in which the x and y values are entered one at a time.  
