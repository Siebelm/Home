...
* <a href="#Q4">How does sentiment usually change of the course of one school year?</a>
...
knitr::opts_chunk$set(echo=TRUE, message=FALSE, comment=NA, warning=FALSE, tidy=TRUE, results="hold", cache=FALSE, dpi=240, out.width = "75%", out.height = "75%")
...
<div id="Q4">
<h6>*How does sentiment usually change of the course of one school year?*</h6>
</div>
