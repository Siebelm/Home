cd "C:\Users\siebe\Documents\16_GitHub\siebelm.github.io\Dealing_With_Rare_Events"

pygmentize -L styles

# Convert Jupyter file to html
jupyter nbconvert --to html "Dealing With Rare Events.ipynb" --CSSHTMLHeaderPreprocessor.style=stata-dark 


# Original file
$orignal = "Dealing With Rare Events.html"
# Output file
$index = "index.html"
